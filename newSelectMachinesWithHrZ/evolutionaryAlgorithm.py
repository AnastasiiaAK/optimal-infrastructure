...
def evolution_algorithm_for_parallel_tasks(max_number_of_machine, max_possible_configuration, evaluate, number_of_generation, size_of_population, CXPB=0.8, MUTPB=0.2):
    ...
    toolbox.register("individual", tools.initRepeat, creator.Individual, toolbox.n_per_product, n=2000)  # create from n_per_product fucntion one individual
    ...
    print(best_fit)
    return best[0], best_fit, calculate_time_and_price_of_current_set_of_machines(best[0])
...
#evolution_algorithm_for_parallel_tasks(16, len(sorted_list_of_configuration_machine), evaluate, 50, 350) # max_number_of_machine, max_possible_configuration, evaluate, number_of_generation, size_of_population, maximum_values_of_machine
