...
def scheduling_for_non_paralleling_task(id_of_task, current_time, machines, tasks_dataframe):
    ...
    number_of_machine = tasks_dataframe[tasks_dataframe["priority"] == priority_of_current_task].size
    ...
    tasks_dataframe.at[id_of_task, "executingTime"] = working_time + transfer_time
