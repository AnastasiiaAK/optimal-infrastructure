...
data = [
    [0, 0, round(120.952686309814453, 2), 0.119 / 300, 300, 200, 0, None, None, None, None, None, None, None,  None, None,
     "No"],
    [1, 1, round(100.46989250183105, 2), 0.3824 / 200, 200, 500, 0, None, None, None, None, None, None, None,  None, None,
     "No"],
    [2, 2, round(100.0005393028259277344, 4), 0.0005393 / 500, 500, 1000, 0, None, None, None, None, None, None,  None, None,
     None, "No"],
    [3, 3, round(160.6666145324707031, 2), 1.66661 / 1000, 1000, 780, 0, None, None, None, None, None, None, None, None,
     None, "No"],
    [4, 4, round(500.2022745609283, 2), 1451.2022 / 780, 780, 880, 1, None, None, None, None, None, None,  None, None,
     None, "No"],
    [5, 5, round(60.7854, 2), 0.67854 / 880, 880, 200, 0, None, None, None, None, None, None, None, None,  None, "No"],
    [6, 6, round(40.34657, 2), 0.48346 / 200, 200, 0, 0, None, None, None, None, None, None, None, None, None, "No"]]
...
def interval_price(descriptionOffTask):
    pass
