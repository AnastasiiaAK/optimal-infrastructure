...
def from_list_machine_configuration(list_of_seq_machine, list_of_parallel_machine):
    ...
    for prior in priority:
        if prior != 0:
            ...
            scheduling_table_of_current_package["endTime"] = np.where(
                scheduling_table_of_current_package["priority"] == prior, scheduling_table_of_current_package["startTime"] + scheduling_table_of_current_package["executingTimeWithTransfer"], 0)
