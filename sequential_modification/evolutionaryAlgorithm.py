from sequential_modification.find_optimal_minimum_and_maximum_numbers_of_machine import define_task, proportion_of_price_for_different_type_of_tasks, find_common_price
import itertools
...
def calculate_time_and_price_of_current_set_of_machines(sample_of_machines):
    ...
    switch_sequential = ConfigurationOfSwitches(4)
...
if max_number_of_machine > 1:
    sequential_set, best_fit = evolution_algorithm_for_parallel_tasks(max_number_of_machine, len(sorted_list_of_configuration_machine_sequential), evaluate_sequential , 2, 250, n_per_product_seq) # max_number_of_machine, max_possible_configuration, evaluate, number_of_generation, size_of_population, maximum_values_of_machine
...
best_machine_evolution, _ = evolution_algorithm_for_parallel_tasks(16, len(sorted_list_of_configuration_machine), evaluate,n_per_product, 2, 50) # max_number_of_machine, max_possible_configuration, evaluate, number_of_generation, size_of_population
