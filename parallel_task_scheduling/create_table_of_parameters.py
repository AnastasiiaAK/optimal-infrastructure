import pandas as pd
from parallel_task_scheduling.greedyAlgorithm import scheduling_table_of_current_package, class_machines_parallel_greedy, selected_machines_sequential_greedy, selected_machines_parallel_greedy
from parallel_task_scheduling.evolutionaryAlgorithm import res_table_evolution, machines_for_parallel_evolution, best_machine_evolution, sorted_list_of_configuration_machine, sample_sequential_init
from parallel_task_scheduling.parameters import dictFreq, dictSwitches
